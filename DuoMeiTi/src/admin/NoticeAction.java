...
public class NoticeAction extends PageGetBaseAction {
	...
	public String resourceFile() throws Exception {
		...
		// notice = this.makeCurrentPageList(q, 10); // 根据代表总体的Criteria
		...
		// {
		// file_path_html =
		// util.Util.getJspOutput("/jsp/admin/HomepageModify/notice.jsp");
	...
	public String add() {
		...
		if (submit_type.equals("add")) {
			...
			Criteria q = session.createCriteria(Notice.class).add(Restrictions.eq("id", id));
