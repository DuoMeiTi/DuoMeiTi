...
public class RepairRecordAction extends ActionSupport {
	...
	public String search() throws Exception {
		...
		if (selectDevice != -1) {
			...
			// c.createAlias("device",
			// "device").add(Restrictions.eq("device.rtType",
			// util.Util.DeviceList.get(selectDevice)));
		}
	...
	public String export() throws Exception {
		...
		// OutputStream out = new FileOutputStream(util.Util.RootPath +
		// util.Util.RecordExportPath + FileName);
	...
	// try {
	// int user_id = (int)
	// ActionContext.getContext().getSession().get("user_id");
