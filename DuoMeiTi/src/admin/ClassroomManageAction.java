...
// implements RequestAware
{
	...
	// session.createCriteria(Classroom.class).setFetchMode("repertorys",
	// FetchMode.SELECT).setFetchMode("checkrecords", FetchMode.SELECT);
	//
	// ////////////////////////
	// if (currPage == 0) {
	// currPage = 1;
	...
	// t_classroom.principal_name = classroom.principal == null ? "" :
	// classroom.principal.user.getFullName();
	// t_classroom.principal_stuId = classroom.principal == null ? "" :
	// classroom.principal.getStudentId();
	...
	// classroom_criteria.add(Restrictions.eq("classroom_num",
	// query_condition));
	// }
	// else{
	...
	// System.out.println(classroom.id + " " + classroom.classroom_num + " " +
	// classroom.principal.user.getUsername() + " " + sb.toString());
	// classrooms.add(t_classroom);
	...
	//
	// System.out.println("stuId:" + stuId + "add_classroom_num:" +
	// add_classroom_num +"build_id:" +build_id+ "build_name:"+build_name);
	//
