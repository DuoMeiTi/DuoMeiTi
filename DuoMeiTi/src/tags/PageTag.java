...
//
// } else {
// sb.append("<li><a href=\"" + path + param + "=" + (currPage - 1) +
// "\">上一页</a></li>" +
...
// int end = begin + pageNumber * 2 > totalPage ? totalPage : begin + pageNumber
// * 2;
// int i;
...
// }
// sb.append("<li
// class=\"disabled\"><span>").append(currPage).append("</span></li>");
...
// } else {
// sb.append("<li><a href=\"" + path + param + "=" + totalPage +
// "\">末页</a></li>" +
// "<li><a href=\"" + path + param + "=" + (currPage + 1) + "\">下一页</a></li>");
// }
// sb.append("<li>&nbsp;&nbsp;&nbsp;&nbsp;总共<font color=\"red\">" + totalSize +
// "</font>条结果&nbsp;&nbsp;&nbsp;&nbsp;" +
// "当前<font color=\"red\">" + currPage + "</font>/<font color=\"red\">" +
// pageCount + "页</font></li>&nbsp;&nbsp;&nbsp;&nbsp;</ul></div>");
// out.println(sb);
// }
// }
