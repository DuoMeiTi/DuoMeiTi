...
public class PageGetBaseAction extends ActionSupport {
	...
	/*
	 * page_num:第几页，页数， 从第一页开始计数 page_size:每一页显示的元素条数
	 * total_num:元素的总数，元素的条数从0开始计数 返回一个长度为3的数组： 第0个元素表示这个页的起始条目的索引，
	 * 第1个元素表示这个页容纳的元素数目， 第2个元素表示总页数
	 */
	...
	public List makeCurrentPageList(Criteria q, int page_size) {
		...
		System.out.println("makeCurrentPageList " + this.currentPageNum + "  " + this.totalPageNum + " "
				+ this.isAjaxTransmission);
