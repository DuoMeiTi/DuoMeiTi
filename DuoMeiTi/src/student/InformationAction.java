...
public class InformationAction extends FileUploadBaseAction {
	...
	public String execute() throws Exception {
		...
		StudentProfile currentStudentProfile = util.Util.getUniqueResultWithOneEqualRestriction(session,
				StudentProfile.class, "user.username", ActionContext.getContext().getSession().get("username"));
		session.close();
	...
	public String modify() throws Exception {
		...
		String[] studentProfileList = { "studentId", "idCard", "college", "bankCard", "entryTime", "user.fullName",
				"user.sex", "user.remark", "user.phoneNumber" };

		util.Util.copyWithSpecificFields(newStudentProfile, currentStudentProfile, studentProfileList);
