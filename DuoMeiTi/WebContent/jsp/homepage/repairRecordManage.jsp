			...
			<div class="modal-body">
				...
				学生列表（可以添加多个学生，按空格分割）：
					<div class="row"  >
					  ...
					  <div class="col-md-3">					    
						    <select class="form-control" id= "studentInfoType">
						    	<option value="studentNames"> 按姓名</option>
						    	<option value="studentIds"> 按学号</option>
						    </select>
					  </div>
					  
					  <div class="col-md-9">
					      <input class="form-control" id="studentNamesOrIds">
...
// 	alert("FFFsss")
	...
	studentNamesOrIds = $("#studentNamesOrIds").val();
	studentInfoType = $("#studentInfoType").val();
	...
	$.ajax({
		...
		data : {
				...
				"save_detail" : repairdetail,
				"save_studentNamesOrIds" : studentNamesOrIds,
				"save_studentInfoType" : studentInfoType,
				}, 
		success : function(data){
